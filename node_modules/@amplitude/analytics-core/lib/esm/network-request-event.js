 ...
 */
var ConsumptionCheck = /** @class */ (function () {
    function ConsumptionCheck() {
        this.headers = false;
        this.body = false;
    }
    ConsumptionCheck.prototype.consume = function (objType) {
        if (this[objType]) {
            throw new TypeError("".concat(objType, " has already been consumed"));
        }
        this[objType] = true;
    };
...
var RequestWrapperFetch = /** @class */ (function () {
    function RequestWrapperFetch(request) {
        ...
        this.consumptionCheck = new ConsumptionCheck();
    }
...
var ResponseWrapperFetch = /** @class */ (function () {
    ...
    ResponseWrapperFetch.prototype.text = function () {
        return __awaiter(this, void 0, void 0, function () {
            var clonedResponse, textPromise, timer, text, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.consumptionCheck.consume('body');
                        clonedResponse = this.response.clone();
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        textPromise = clonedResponse.text();
...
var ResponseWrapperXhr = /** @class */ (function () {
    function ResponseWrapperXhr(statusCode, headersString, size, responseText) {
