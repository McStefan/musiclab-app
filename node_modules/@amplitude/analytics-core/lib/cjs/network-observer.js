    ...
    NetworkObserver.prototype.observeXhr = function (originalXhrOpen, originalXhrSend, originalXhrSetRequestHeader) {
        ...
        xhrProto.send = function () {
            ...
            xhrSafe.addEventListener('loadend', function () {
                ...
                try {
                    ...
                    /* istanbul ignore next */
                    responseBodySize ? parseInt(responseBodySize, 10) : undefined, xhrSafe.responseText);
        ...
        xhrProto.setRequestHeader = function (headerName, headerValue) {
            ...
            try {
                ...
                /* istanbul ignore next */
                (_a = networkObserverContext.logger) === null || _a === void 0 ? void 0 : _a.debug('an unexpected error occurred while calling xhr setRequestHeader', err);
            }
            /* eslint-disable-next-line @typescript-eslint/no-unsafe-argument */
